    ...
    <div className="container max-w-2xl mx-auto py-12">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div className="flex gap-2 mb-6">
          <button
            onClick={() => setMode('add')}
            className={`flex-1 py-2 px-4 rounded-lg font-semibold transition-colors ${mode === 'add'
          ...
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-lg font-semibold transition-colors ${mode === 'remove'
                ? 'bg-blue-600 text-white'
                : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
              }`}
          >
