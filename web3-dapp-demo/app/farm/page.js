      ...
      <div className="border-t pt-4">
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-lg font-semibold transition-colors ${activeTab === 'deposit'
          ...
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-lg font-semibold transition-colors ${activeTab === 'withdraw'
              ? 'bg-blue-600 text-white'
              : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
              }`}
          >
